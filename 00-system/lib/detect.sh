...
print_resolved_config() {
  ...
  printf '%s\n' \
    ...
    "SYSTEM_SECURE_BOOT_DIR=\"${SYSTEM_SECURE_BOOT_DIR:-}\"" \
    "SYSTEM_SECURE_BOOT_CERT_PATH=\"${SYSTEM_SECURE_BOOT_CERT_PATH:-}\"" \
    "SYSTEM_DKMS_CONF_PATH=\"${SYSTEM_DKMS_CONF_PATH:-}\"" \
    "SYSTEM_SECURE_BOOT_MODULES_CONFIG_PATH=\"${SYSTEM_SECURE_BOOT_MODULES_CONFIG_PATH:-}\"" \
    "SYSTEM_SECURE_BOOT_TOOL_PATH=\"${SYSTEM_SECURE_BOOT_TOOL_PATH:-}\"" \
    "SYSTEM_CUSTOM_MODULE_SOURCE_ROOT=\"${SYSTEM_CUSTOM_MODULE_SOURCE_ROOT:-}\"" \
    "SYSTEM_CUSTOM_MODULE_BUILD_ROOT=\"${SYSTEM_CUSTOM_MODULE_BUILD_ROOT:-}\"" \
    "SYSTEM_SIGN_MODULE_HELPER=\"${SYSTEM_SIGN_MODULE_HELPER:-}\"" \
    "SYSTEM_KERNEL_POSTINST_HOOK_PATH=\"${SYSTEM_KERNEL_POSTINST_HOOK_PATH:-}\"" \
    "SYSTEM_KERNEL_HEADER_POSTINST_HOOK_PATH=\"${SYSTEM_KERNEL_HEADER_POSTINST_HOOK_PATH:-}\"" \
